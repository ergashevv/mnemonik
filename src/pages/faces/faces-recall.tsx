...
import useFacesNext from '../../hooks/use-faces-button/use-faces-next'
import useFacesPrev from '../../hooks/use-faces-button/use-faces-prev'
import './faces.scss'
...
const FacesRecall = () => {
  ...
  const handleNavigate = () => {
    navigate('/names-and-faces/result')
    setCurrentPageFaces(1)
  }
      ...
      <div className='container'>
        <div className='faces-section'>
          <div className='faces-section__header'>
            <TimerComponent time={timerForAnswer} navigateTo={'/names-and-faces/result'} />
            <button
